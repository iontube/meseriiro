 ...
 * Day 1 = first sitemap only, Day 2 = first 2, etc.
 *
 * Usage:
 *   node scripts/drip-sitemap-index.mjs           # auto-calculate day from start date
 *   node scripts/drip-sitemap-index.mjs 5          # force day 5 (first 5 sitemaps)
 *   node scripts/drip-sitemap-index.mjs all        # include all sitemaps
 */
...
// Calculate how many sitemaps to include
